...
int Schema::renameRel(char oldRelName[ATTR_SIZE], char newRelName[ATTR_SIZE]) {
  ...
  // Catalog, return E_NOTPERMITTED (check if the relation names are either
  // "RELATIONCAT" and "ATTRIBUTECAT". you may use the following constants:
  // RELCAT_RELNAME and ATTRCAT_RELNAME)
...
int Schema::createRel(char relName[], int nAttrs, char attrs[][ATTR_SIZE],
  ...
  // Reset the searchIndex using RelCacheTable::resetSearhIndex()  // of RELCAT
  ...
  targetRelId = BlockAccess::linearSearch(RELCAT_RELID, RELCAT_ATTR_RELNAME,
...
int Schema::dropIndex(char *relName, char *attrName) {
  ...
  int rootBlock =
      attrCatEntry.rootBlock; /* get the root block from attrcat entry */
